    ...
    public static IMapConfig[] mapCOnfig = new IMapConfig[] {
            ...
            new IMapConfig
        {
                ...
                foodConfigs = new IFoodConfig[]{
                        new IFoodConfig{name= Food.FoodNames.Tomato, startMatrix = new Vector2(0, 0) },
                        new IFoodConfig{name= Food.FoodNames.Cheese, startMatrix = new Vector2(0, 1) },
                        new IFoodConfig{name= Food.FoodNames.Cheese, startMatrix = new Vector2(0, 2) },
                        new IFoodConfig{name= Food.FoodNames.Bread, startMatrix = new Vector2(1, 0) },
                        new IFoodConfig{name= Food.FoodNames.Bread, startMatrix = new Vector2(2, 0) },
                        new IFoodConfig{name= Food.FoodNames.Lettuce, startMatrix = new Vector2(2, 1) },
                        new IFoodConfig{name= Food.FoodNames.Egg, startMatrix = new Vector2(1, 2) },
                        new IFoodConfig{name= Food.FoodNames.Lettuce, startMatrix = new Vector2(2, 2) }
                }
        },
                ...
                new IMapConfig
        {
                ...
                foodConfigs = new IFoodConfig[]{
                        new IFoodConfig{name= Food.FoodNames.Lettuce, startMatrix = new Vector2(1, 0) },
                        new IFoodConfig{name= Food.FoodNames.Lettuce, startMatrix = new Vector2(0, 1) },
                        new IFoodConfig{name= Food.FoodNames.Tomato, startMatrix = new Vector2(1, 1) },
                        new IFoodConfig{name= Food.FoodNames.Cheese, startMatrix = new Vector2(0, 2) },
                        new IFoodConfig{name= Food.FoodNames.Egg, startMatrix = new Vector2(1, 2) },
                        new IFoodConfig{name= Food.FoodNames.Cheese, startMatrix = new Vector2(0, 3) },
                        new IFoodConfig{name= Food.FoodNames.Bread, startMatrix = new Vector2(1, 3) },
                        new IFoodConfig{name= Food.FoodNames.Bread, startMatrix = new Vector2(2, 3) }
                }
        }
    };
}
